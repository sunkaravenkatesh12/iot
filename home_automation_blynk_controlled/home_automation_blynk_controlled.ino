...
#define BLYNK_TEMPLATE_ID        "TMPL5UID_ybAo"
#define BLYNK_TEMPLATE_NAME      "Home Automation"
#define BLYNK_AUTH_TOKEN         "dApHBLVtFygw1zWE_OX_7EYOytOOzZJf"
...
{/*to read the ststus of inlet button*/
...
void handle_temp(void)
{
    ...
    //read temp and compare with 35 degree C
...
void handle_tank(void)
{
  ...
  if((tank_volume < 2000) && (inlet_sw == 0))
  {
    enable_inlet();
    inlet_sw = 1;
    /*reflect the status of the switch on blynk app */
...
{
  brightness_control();
  temp = String (read_temperature() , 2);// reading only 2 fields
  lcd.setCursor(2,0);
  lcd.print(temp);
